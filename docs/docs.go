...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/reporting/activity-log-stats": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/reporting/top-bookmarked-recipes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/reporting/top-liked-recipes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateMenuStatusInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateTagInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateTagInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/me/verify-reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Kode verifikasi dan password baru",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/menus": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Langkah-langkah (JSON)",
                        "name": "instructions",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Tag IDs (comma separated, misal: 1,2,3)",
                        "name": "tag_ids",
                        "in": "formData"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AddTagInput"
                        }
                    }
                ],
                "responses": {
